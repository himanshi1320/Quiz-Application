...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name) {
        ...
        setBounds(50, 0, 1400, 800);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);

        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/quiz.jpg"));
        JLabel image = new JLabel(i1);
        image.setBounds(0, 0, 1390, 400);
        add(image);

        qno = new JLabel();
        qno.setBounds(100, 460, 60, 39);
        qno.setFont(new Font("Tahoma", Font.BOLD, 30));
        add(qno);

        ques = new JLabel();
        ques.setBounds(150, 460, 900, 30);
        ques.setFont(new Font("Tahoma", Font.BOLD, 30));
        add(ques);
    ...
    public void paint(Graphics g) {
        ...
        if (timer > 0) {
            ...
            g.drawString("Times up!!", 1100, 510);
        }
        timer--;
        try {
            Thread.sleep(1000);
